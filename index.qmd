...
# main data
elements = read_csv("data/gw15_elements.csv") 
stats = read_csv("data/gw15_stats.csv")
scores = read_csv("data/gw15_scoreboard.csv") 
scoreboard = read_csv("data/gw15_scores.csv") 
