...
# main data
elements = read_csv("data/gw21_elements.csv") 
stats = read_csv("data/gw21_stats.csv")
scores = read_csv("data/gw21_scoreboard.csv") 
scoreboard = read_csv("data/gw21_scores.csv") 
