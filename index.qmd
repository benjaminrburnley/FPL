...
# main data
elements = read_csv("data/gw37_elements.csv")
stats = read_csv("data/gw37_stats.csv")
scores = read_csv("data/gw37_scoreboard.csv")
scoreboard = read_csv("data/gw37_scores.csv")
