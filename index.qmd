...
# main data
elements = read_csv("data/gw29_elements.csv")
stats = read_csv("data/gw29_stats.csv")
scores = read_csv("data/gw29_scoreboard.csv")
scoreboard = read_csv("data/gw29_scores.csv")
