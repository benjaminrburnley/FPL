...
# main data
elements = read_csv("data/gw23_elements.csv")
stats = read_csv("data/gw23_stats.csv")
scores = read_csv("data/gw23_scoreboard.csv")
scoreboard = read_csv("data/gw23_scores.csv")
...
kable(best_gameweek, col.names = c("Manager", "GW", "Points+", "Total Points")) %>% 
  kable_material()
```
