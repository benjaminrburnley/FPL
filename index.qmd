...
# main data
elements = read_csv("data/gw11_elements.csv") 
stats = read_csv("data/gw11_stats.csv")
scores = read_csv("data/gw11_scoreboard.csv") 
scoreboard = read_csv("data/gw11_scores.csv") 
