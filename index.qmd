...
# main data
elements = read_csv("data/gw38_elements.csv")
stats = read_csv("data/gw38_stats.csv")
scores = read_csv("data/gw38_scoreboard.csv")
scoreboard = read_csv("data/gw38_scores.csv")
