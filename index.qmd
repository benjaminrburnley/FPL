...
# main data
elements = read_csv("data/gw03_elements.csv") 
stats = read_csv("data/gw03_stats.csv")
scores = read_csv("data/gw03_scoreboard.csv") 
scoreboard = read_csv("data/gw03_scores.csv") 
