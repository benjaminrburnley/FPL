...
# main data
elements = read_csv("data/gw10_elements.csv") 
stats = read_csv("data/gw10_stats.csv")
scores = read_csv("data/gw10_scoreboard.csv") 
scoreboard = read_csv("data/gw10_scores.csv") 
