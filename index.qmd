...
# main data
elements = read_csv("data/gw18_elements.csv") 
stats = read_csv("data/gw18_stats.csv")
scores = read_csv("data/gw18_scoreboard.csv") 
scoreboard = read_csv("data/gw18_scores.csv") 
