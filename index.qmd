...
# main data
elements = read_csv("data/gw16_elements.csv") 
stats = read_csv("data/gw16_stats.csv")
scores = read_csv("data/gw16_scoreboard.csv") 
scoreboard = read_csv("data/gw16_scores.csv") 
