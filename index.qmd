...
# main data
elements = read_csv("data/gw13_elements.csv") 
stats = read_csv("data/gw13_stats.csv")
scores = read_csv("data/gw13_scoreboard.csv") 
scoreboard = read_csv("data/gw13_scores.csv") 
