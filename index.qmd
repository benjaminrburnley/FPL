...
# main data
elements = read_csv("data/gw20_elements.csv") 
stats = read_csv("data/gw20_stats.csv")
scores = read_csv("data/gw20_scoreboard.csv") 
scoreboard = read_csv("data/gw20_scores.csv") 
