...
# main data
elements = read_csv("data/gw08_elements.csv") 
stats = read_csv("data/gw08_stats.csv")
scores = read_csv("data/gw08_scoreboard.csv") 
scoreboard = read_csv("data/gw08_scores.csv") 
