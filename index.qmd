...
# main data
elements = read_csv("data/gw19_elements.csv") 
stats = read_csv("data/gw19_stats.csv")
scores = read_csv("data/gw19_scoreboard.csv") 
scoreboard = read_csv("data/gw19_scores.csv") 
